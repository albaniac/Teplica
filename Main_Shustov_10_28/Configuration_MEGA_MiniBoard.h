...
//--------------------------------------------------------------------------------------------------------------------------------
// скорость работы I2C
#define I2C_SPEED 100000UL // 100кГц, поменять на 400000UL для скорости 400кГц
//--------------------------------------------------------------------------------------------------------------------------------
...
#define TIMERS_DRIVE_MODE DRIVE_DIRECT // прямое управление пинами, также можно рулить через расширители портов (MCP23S17 и MCP23017)
...
// (настройка актуальна при раскомментированной USE_TIMER_MODULE)
#define TIMERS_MCP23017_ADDRESS 0 // 0 - первая микросхема по адресу 0x20, 1 - вторая по адресу 0x21 и т.п.
//--------------------------------------------------------------------------------------------------------------------------------
...
#define SUPPORTED_SENSORS 0 // кол-во поддерживаемых проводных датчиков температуры, подсоединённых к контроллеру
...
// ДЛЯ ПЛАТЫ ВЫВОДЫ ПО УМОЛЧАНИЮ, ПОДТЯНУТЫЕ РЕЗИСТОРАМИ - A11, A12, A13
#define TEMP_SENSORS_PINS A11 //, 32 // пины, на которых висят наши датчики температуры (указываются через запятую, общее кол-во равно SUPPORTED_SENSORS)
...
#define WAIT_SCREEN_SENSORS W_S(StateTemperature,0,"STATE","T внутри")
...
#define WATERFLOW_SENSORS_COUNT 0 // доступные значения: 0, 1, 2. Если 0 - никакие показания сниматься не будут, следовательно, пины FIRST_WATERFLOW_PIN и SECOND_WATERFLOW_PIN останутся свободны
...
#define WIFI_REBOOT_PIN 11 // номер пина, на котором будет управление питанием ESP (актуально при раскомментированной команде USE_WIFI_REBOOT_PIN)
