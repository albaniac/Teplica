...
//--------------------------------------------------------------------------------------------------------------------------------
#define SUPPORTED_SOIL_MOISTURE_SENSORS 5 // кол-во проводных датчиков влажности почвы

#define SOIL_MOISTURE_SENSORS {A3, ANALOG_SOIL_MOISTURE}, {A4, ANALOG_SOIL_MOISTURE}, {A8, ANALOG_SOIL_MOISTURE}, {A9, ANALOG_SOIL_MOISTURE}, {A10, ANALOG_SOIL_MOISTURE}//,{A2, FREQUENCY_SOIL_MOISTURE} // АНАЛОГОВЫЕ пины, на которых сидят датчики влажности почвы (через запятую, кол-во равно SUPPORTED_SOIL_MOISTURE_SENSORS!)
