...
#define SOIL_MOISTURE_SENSORS {A3, ANALOG_SOIL_MOISTURE}//,{A2, FREQUENCY_SOIL_MOISTURE} // АНАЛОГОВЫЕ пины, на которых сидят датчики влажности почвы (через запятую, кол-во равно SUPPORTED_SOIL_MOISTURE_SENSORS!)
...
// адрес микросхемы MCP23S17, через которую рулим пином насоса (если управление в режиме DRIVE_MCP23S17)
#define WATER_PUMP2_MCP23S17_ADDRESS 1
...
// 1. Для прямого управления пинами (DRIVE_DIRECT - номер пина)
// 2. Для управления через DRIVE_MCP23S17 и DRIVE_MCP23017 - номер канала микросхемы
#define SECOND_PUMP_RELAY_PIN 8
...
//#define TFT_SENSORS {"STATE",StateTemperature,1,"Снаружи теплицы"}, {"STATE",StateTemperature,0,"Внутри секции 1"}, {"HUMIDITY",StateTemperature,1,"Внутри секции 2"}, {"HUMIDITY",StateHumidity,0,"Влажность DHT22"}, {"SOIL",StateSoilMoisture,0,"Влажность почвы"}, {"LIGHT",StateLuminosity,0,"Освещённость"}
