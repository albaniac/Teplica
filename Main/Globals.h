...
#define HTTP_API_KEY_ADDRESS 4035 // адрес, ко которому хранится ключ доступа к HTTP API (32 символа без пробелов + 2 байта - заголовок присутствия)
//--------------------------------------------------------------------------------------------------------------------------------
// настройки Serial
//--------------------------------------------------------------------------------------------------------------------------------
...
#define HTTP_SERVER_IP "192.168.1.33" // адрес хоста, который мы опрашиваем на команды (IP или доменное имя)
#define HTTP_SERVER_HOST "gh-local.ru" // имя хоста (для заголовка Host)
