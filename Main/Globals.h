...
//#define HTTP_SERVER_IP "192.168.1.33" // IP-адрес хоста, который мы опрашиваем на команды
#define HTTP_SERVER_IP  "www.ntmp.ru" // IP-адрес хоста, который мы опрашиваем на команды
//#define HTTP_SERVER_HOST "gh-local.ru" // имя хоста
#define HTTP_SERVER_HOST "www.ntmp.ru" // имя хоста
#define HTTP_APY_KEY "123456" // ключ доступа к сервису
#define HTTP_POLL_INTERVAL 60 // через сколько секунд проверять на команды
