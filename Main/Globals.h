...
#define WATER_PUMP_MCP23S17_ADDRESS 7
...
#define HTTP_SERVER_IP "192.168.1.106" // IP-адрес хоста, который мы опрашиваем на команды
//#define HTTP_SERVER_IP "www.test2.ru" // IP-адрес хоста, который мы опрашиваем на команды
#define HTTP_SERVER_HOST "www.test2.ru" // имя хоста
