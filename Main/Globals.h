...
// ДЛЯ ПЛАТЫ ВЫВОДЫ ПО УМОЛЧАНИЮ, ПОДТЯНУТЫЕ РЕЗИСТОРАМИ - A11, A12, A13
#define TEMP_SENSORS_PINS ADD_T(A11,DS1820)//, ADD_T(32,DS18B20) // пины, на которых висят наши датчики температуры (указываются через запятую, общее кол-во равно SUPPORTED_SENSORS)
...
#define WATER_RELAYS_COUNT 16 // сколько каналов управления поливом используется
...
#define WATER_RELAYS_PINS 23,24,25,27,23,24,25,27,23,24,25,27,23,24,25,27
