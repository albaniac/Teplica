...
//--------------------------------------------------------------------------------------------------------------------------------
// настройки расширителей портов MCP23S17 (актуально, если USE_MCP23S17_EXTENDER определено; в остальных случаях эти настройки игнорируются)
//--------------------------------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------------------------
// настройки расширителей портов MCP23017 (актуально, если USE_MCP23017_EXTENDER определено; в остальных случаях эти настройки игнорируются)
//--------------------------------------------------------------------------------------------------------------------------------
...
#define WATERFLOW_EEPROM_ADDR 500 // с какого адреса у нас будут записываться показания датчиков расхода воды (пишутся только накопительные показания, по 4 байта на счётчик, 2 счётчика = 8 байт, 2 байта - факторы калибровки, 2 оставшихся - про запас)
...
#define PH_SETTINGS_EEPROM_ADDR 2800 // с какого адреса идут настройки PH-модуля: заголовок (2 байта), номер пина, с которого читать показания (1 байт), калибровка (в сотых долях, 2 байта), остальное - пока резерв
#define TIMERS_EEPROM_ADDR 2850 // у нас 4 таймера, на каждый - 10 байт + заголовок (2 байта), итого - 42 байта 
#define RESERVATION_ADDR 2900 // адрес, с которого пишутся настройки резервирования (173 байта до составных команд; 10 списков по 12 байт + 3 байта = 123 байта, запас ещё есть)
...
//--------------------------------------------------------------------------------------------------------------------------------
// [DRIVE_DIRECT, DRIVE_MCP23S17, DRIVE_MCP23017]
#define LIGHT_DRIVE_MODE DRIVE_DIRECT // прямое управление пинами, также можно рулить через расширители портов 
...
#define SUPPORTED_WINDOWS 8 // кол-во поддерживаемых окон (по два реле на мотор, для 8-ми канального модуля реле - 4 окна)
...
//--------------------------------------------------------------------------------------------------------------------------------
// [DRIVE_DIRECT, DRIVE_MCP23S17, DRIVE_MCP23017]
#define WATER_DRIVE_MODE DRIVE_MCP23017//DRIVE_DIRECT // прямое управление пинами, также можно рулить через расширители портов 
...
// как управляем пином насоса
// [DRIVE_DIRECT, DRIVE_MCP23S17, DRIVE_MCP23017]
#define WATER_PUMP_DRIVE_MODE DRIVE_MCP23017 // прямое управление пином, также можно рулить через расширители портов 
...
#define WATER_RELAYS_COUNT 4 // сколько каналов управления поливом используется
...
#define WATER_RELAYS_PINS 1,2,3,4 
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//--------------------------------------------------------------------------------------------------------------------------------
// запрещаем использование более 8 каналов полива в прошивке
//--------------------------------------------------------------------------------------------------------------------------------
#if WATER_RELAYS_COUNT > 8
#error WATER CHANNELS IS LIMITED to 8 !!!
#endif
//--------------------------------------------------------------------------------------------------------------------------------
// запрещаем использование более 16 окон в прошивке
//--------------------------------------------------------------------------------------------------------------------------------
