...
69	D69 / CANTX0	Регистратор модулей
70	D70/SDA1	    вариант 2     I2C
71	D71/SCL1	    вариант 2     I2C
...
адр1	MCP23017	Модуль управления досветкой  (адр1)
адр2	MCP23017	Модуль резерв (адр2)
адр3	MCP23017	Расширитель портов   (адр3)

адр3	MCP23017	A0 - Windows №1,7
адр3	MCP23017	A1 - Windows №2,7
адр3	MCP23017	A2 - Windows №3,7
адр3	MCP23017	A3 - Windows №4,7
адр3	MCP23017	A4 - Windows №5,7
адр3	MCP23017	A5 - Windows №6,7
адр3	MCP23017	A6 - Windows №7,7
адр3	MCP23017	A7 - Windows №8,7

адр3	MCP23017	A8  - SOUNDER (пищалка)
адр3	MCP23017	A9  - USE_READY_DIODE BLUE_DIODE
адр3	MCP23017	A10 - USE_WINDOWS_MANUAL_MODE_DIODE RED_DIODE
адр3	MCP23017	A11 - USE_WATERING_MANUAL_MODE_DIODE Yellow DIODE
адр3	MCP23017	A12 - USE_LIGHT_MANUAL_MODE_DIODE GREEN_DIODE
адр3	MCP23017	A13 - Вход управления подсветкой дисплея
адр3	MCP23017	A14 - Питание LoRa
адр3	MCP23017	A15 - Свободен
...
#define LED_RED      4                                 // Индикация светодиодом RED
#define LED_BLUE     5                                 // Индикация светодиодом BLUE
#define LED_GREEN    6                                 // Индикация светодиодом GREEN
...
//#endif 
//
//	Bank3.digitalWrite(LED_RED, red);
//	Bank3.digitalWrite(LED_GREEN, green);
//	Bank3.digitalWrite(LED_BLUE, blue);
//}
