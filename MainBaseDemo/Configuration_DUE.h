...
#define LIGHT_SENSORS_COUNT 0 // кол-во проводных датчиков освещенности на шине I2C, 0-4
...
// адрес микросхемы MCP23017, через которую рулим каналами досветки (если управление в режиме DRIVE_MCP23017)
// (настройка актуальна при раскомментированной USE_SOIL_MOISTURE_SENSORS_POWER_MANAGEMENT)
#define SOIL_MOISTURE_MCP23017_ADDRESS 2 // 0 - первая микросхема по адресу 0x20, 1 - вторая по адресу 0x21 и т.п.

// пин управления питанием датчиков влажности почвы (или номер канала MCP*, если управление 
// в режимах, отличных от DRIVE_DIRECT)
// (настройка актуальна при раскомментированной USE_SOIL_MOISTURE_SENSORS_POWER_MANAGEMENT)
#define SOIL_MOISTURE_POWER_PIN 1
...
#define TEMP_SENSORS_PINS ADD_T(54,DS18B20), ADD_T(55,DS18B20), ADD_T(55,DS18B20)// пины, на которых висят наши датчики температуры (указываются через запятую, общее кол-во равно SUPPORTED_SENSORS)
...
// 0 - первая микросхема по адресу 0x20, 1 - вторая по адресу 0x21 и т.п.
#define TFT_BACKLIGHT_MCP23017_ADDRESS 1 
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define TFT_SENSORS {"STATE",StateTemperature,1,"Снаружи теплицы"}, {"STATE",StateTemperature,0,"Внутри секции 1"}, {"STATE",StateTemperature,2,"Внутри секции 2"}, {"HUMIDITY",StateHumidity,0,"ВлажностьSi7021"}, {"HUMIDITY",StateHumidity,2,"Влажность DHT11"}, {"LIGHT",StateLuminosity,0,"Освещённость"}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
