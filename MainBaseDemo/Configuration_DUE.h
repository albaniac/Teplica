...
#define WATCHDOG_PULSE_DURATION 200 // сколько миллисекунд держать высокий уровень на ноге

//--------------------------------------------------------------------------------------------------------------------------------
// НАСТРОЙКИ УНИВЕРСАЛЬНЫХ МОДУЛЕЙ (актуально при раскомментированной команде USE_UNIVERSAL_MODULES)
//--------------------------------------------------------------------------------------------------------------------------------
#define UNI_REGISTRATION_PIN 69 // номер пина, на котором будут регистрироваться модули в системе (актуально при раскомментированной команде USE_UNI_REGISTRATION_LINE)
...
#define NRF_REBOOT_PIN 12 // (актуально при раскомментированной команде USE_NRF_REBOOT_PIN) 
...
#define LAMP_RELAYS_PINS 9,10,11,12
...
// (настройка актуальна при раскомментированной USE_SOIL_MOISTURE_SENSORS_POWER_MANAGEMENT)
#define SOIL_MOISTURE_POWER_PIN 13
...
#define WINDOWS_RELAYS_PINS 1,2,3,4,5,6,7,8 
...
#define WATER_PUMP_MCP23S17_ADDRESS 6
...
// раскомментировать, если надо использовать пищалку для звуков при нажатии кнопок на экране
...
#define TFT_SENSORS {"STATE",StateTemperature,1,"Снаружи теплицы"}, {"STATE",StateTemperature,0,"Внутри секции 1"}, {"HUMIDITY",StateTemperature,0,"Внутри секции 2"}, {"HUMIDITY",StateHumidity,0,"Влажность воздух"}, {"SOIL",StateSoilMoisture,0,"Влажность почвы"}, {"LIGHT",StateLuminosity,0,"Освещённость"}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define WIFI_REBOOT_PIN 59 // номер пина, на котором будет управление питанием ESP-модема (актуально при раскомментированной команде USE_WIFI_REBOOT_PIN)
