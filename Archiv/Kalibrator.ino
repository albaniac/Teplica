...
void readCoordinates()
{
  ...
  myGLCD.print("cx - ", 60, 280);
  myGLCD.print("       ", 150, 280);
  myGLCD.printNumI(cx, 150, 280);
  myGLCD.print("  cy - ", 220, 280);
  myGLCD.print("     ", 320, 280);
  myGLCD.printNumI(cy, 320, 280);

	myTouch.read();
	int	x=myTouch.getX();
	int	y=myTouch.getY();

  myGLCD.print("x - ", 60, 300);
  myGLCD.print("     ", 150, 300);
  myGLCD.printNumI(x, 150, 300);
  myGLCD.print("  y - ", 220, 300);
  myGLCD.print("      ", 320, 300);
  myGLCD.printNumI(y, 320, 300);
  

  //myGLCD.print("Rx - ", 60, 320);
  //myGLCD.print("      ", 150, 320);
  //myGLCD.printNumI(myTouch.TP_X1, 150, 320);
  //myGLCD.print("  Ry - ", 220, 320);
  //myGLCD.print("     ", 320, 320);
  //myGLCD.printNumI(myTouch.TP_Y1, 320, 320);
...
void done()
{
 ...
 /*   myGLCD.print("file and change", 88, 74);
    ...
    myGLCD.print("CAL_X", CENTER, 150);
    myGLCD.print("CAL_Y", CENTER, 162);
    myGLCD.print("CAL_S", CENTER, 174);
