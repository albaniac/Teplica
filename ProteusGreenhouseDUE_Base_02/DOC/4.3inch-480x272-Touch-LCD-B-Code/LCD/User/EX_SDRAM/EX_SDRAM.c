...
void SDRAM_Init (void)
{
    ...
    LPC_SC->PCONP |= (1<<11);     //外部存储器控制器功率/时钟控制位。

//   LPC_SC->EMCDLYCTL   = 0x00001010;    //原来的
    LPC_SC->EMCDLYCTL  = 0x000001f1f;      //可编程延迟值
//    LPC_SC->EMCDLYCTL  = (1<<4)|(1<<10);
...
/*EMCCLKSEL EMC 时钟选择寄存器 */
    ...
    LPC_EMC->DynamicConfig0   = (1<<14) | (1<<10) | (1<<9) | (1<<7); /* 256Mb, 16Mx16, 4 banks, row=13, column=9, RBC */
//    LPC_EMC->DynamicConfig0   = (1<<14) | (1<<11) | (1<<7);
