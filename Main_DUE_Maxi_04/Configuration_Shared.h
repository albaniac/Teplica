...
//--------------------------------------------------------------------------------------------------------------------------------
#define W_S(type,index, module, displayName) {(type),(index),(module),(displayName) } // для добавления сенсора в массив

//--------------------------------------------------------------------------------------------------------------------------------
// Настройки Nextion (актуально при раскомментированной команде USE_NEXTION_MODULE)
//--------------------------------------------------------------------------------------------------------------------------------
#define NW_S(type,index, module, caption) {(type),(index),(module), (caption)} // для добавления сенсора в массив
