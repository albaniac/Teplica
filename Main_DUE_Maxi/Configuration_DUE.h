...
#define DS3231_DUE // Тестовая программа часов
...
#define LORA_REBOOT_PIN 69 // (актуально при раскомментированной команде USE_LORA_REBOOT_PIN) 
...
#define DIODE_LIGHT_MANUAL_MODE_PIN 1 // пин или номер канала расширителя портов, на котором висит диод индикации ручного режима управления досветкой (актуально при раскомментированной команде USE_LIGHT_MANUAL_MODE_DIODE)
...
// (настройка актуальна при раскомментированной USE_SOIL_MOISTURE_SENSORS_POWER_MANAGEMENT)
#define SOIL_MOISTURE_MCP23S17_ADDRESS 3
