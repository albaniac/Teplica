...
#define DEF_OPEN_TEMP 27 // температура открытия по умолчанию, градусов Цельсия
#define DEF_CLOSE_TEMP 25 // температура закрытия по умолчанию, градусов Цельсия
...
#define TFT_SENSORS {"STATE",StateTemperature,1,"Снаружи теплицы"}, {"STATE",StateTemperature,0,"Внутри секции 1"}, {"HUMIDITY",StateTemperature,0,"Внутри секции 2"}, {"HUMIDITY",StateHumidity,0,"Влажность Si7021"}, {"HUMIDITY",StateHumidity,1,"Влажность DHT22"}, {"LIGHT",StateLuminosity,0,"Освещённость"}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
