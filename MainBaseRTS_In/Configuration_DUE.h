...
#define TFT_SENSORS {"STATE",StateTemperature,1,"Снаружи теплицы"}, {"STATE",StateTemperature,0,"Внутри секции 1"}, {"HUMIDITY",StateTemperature,0,"Внутри секции 2"}, {"HUMIDITY",StateHumidity,0,"Влажность Si7021"}, {"SOIL",StateSoilMoisture,0,"Влажность почвы"}, {"LIGHT",StateLuminosity,0,"Освещённость"}
