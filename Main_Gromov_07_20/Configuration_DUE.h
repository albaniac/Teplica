...
//--------------------------------------------------------------------------------------------------------------------------------
#define TIMER_ON LOW // уровень, который надо выставлять на пине, когда таймер включён
#define TIMER_OFF HIGH // уровень, который надо выставлять на пине, когда таймер выключён
...
#define SOIL_MOISTURE_UPDATE_INTERVAL 1000 // через сколько мс обновлять показания с датчиков влажности почвы
...
// (настройка актуальна при раскомментированной USE_SOIL_MOISTURE_SENSORS_POWER_MANAGEMENT)
#define SOIL_MOISTURE_POWER_PIN 14
...
#define WATER_RELAYS_COUNT 8 // сколько каналов управления поливом используется (максимум - 16)
...
#define WATER_RELAYS_PINS 0,1,2,3,4,5,6,7
...
#define TFT_SENSORS {"STATE",StateTemperature,1,"Снаружи теплицы"},  {"HUMIDITY",StateTemperature,0,"Внутри секции 1"}, {"STATE",StateTemperature,0,"Внутри секции 2"}, {"HUMIDITY",StateHumidity,0,"Влажность DHT22"}, {"SOIL",StateSoilMoisture,0,"Влажность почвы"}, {"LIGHT",StateLuminosity,0,"Освещённость"}
